...
python3 scripts_train/train_object_order.py --order_seed $order_seed --object_seed $object_seed --experiment_name merge_and_init
EOT
...
python3 scripts_train/train_object_order.py --order_seed $order_seed --object_seed $object_seed --experiment_name mag_max_light
EOT
...
python3 scripts_train/train_object_order.py --order_seed $order_seed --object_seed $object_seed --experiment_name naive_cl
EOT
...
python3 scripts_train/train_object_order.py --order_seed $order_seed --object_seed $object_seed --experiment_name ortho_init
EOT
