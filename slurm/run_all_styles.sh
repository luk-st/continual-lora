...
python3 scripts_cl/train_style_order.py --order_seed $order_seed --style_seed $style_seed --experiment_name merge_and_init
EOT
...
python3 scripts_cl/train_style_order.py --order_seed $order_seed --style_seed $style_seed --experiment_name mag_max_light
EOT
